<?xml version='1.0' ?>
<Channel platform="QuebecPSP.jar" fcldate="10/25/2017" fclversion="A59C" romID="ROM0" cdfW="1080" cdfH="1920" grouping="false">
   <Definitions>
   ...
   <Show name="LQ_carrousel_4" contentHandler="" content="LQ_carrousel_4.sdf" repeat="true" interrupt="true" repeatable="true" persistent="false" active="true" />
   <Show name="LQ_carrousel_5" contentHandler="" content="LQ_carrousel_5.sdf" repeat="true" interrupt="true" repeatable="true" persistent="false" active="true" />
   ...
   <Show name="LQ_carrousel_6" contentHandler="" content="LQ_carrousel_6.sdf" repeat="true" interrupt="true" repeatable="true" persistent="false" active="true" />
</Channel>
